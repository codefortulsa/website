...
4. Write about your band. Get bonus points for uploading and adding any pictures you have of the band by clicking the image button (see right) [![wikiimage](http://codefortulsa.files.wordpress.com/2013/04/wikiimage1.png)](./img/2013-04-wikiimage1.png). Images should be licensed under [Creative Commons](http://creativecommons.org/licenses/by/3.0/ "Creative Commons"). Click "Save Changes" when you're done.
