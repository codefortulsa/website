...
redirect_from: 
            - http://codefortulsa.org/2013/04/24/ww-lets-get-personal/
categories: "Tulsa Wiki, TulsaWiki, Wiki Wednesday"
hero: ./img/2013-04-tulsans.jpg
---
...
[![Some Tulsans](./img/2013-04-tulsans.jpg)](http://codefortulsa.files.wordpress.com/2013/04/tulsans.jpeg)
...
3. When you add a name, highlight the whole name and select the 'Link' button (it looks like the image to the right![WikiLink](./img/2013-04-wikilink.png)). A dialog will pop up. Don't change the text, but click OK. You've created a link to a Tulsa Wiki page that doesn't exist yet.
